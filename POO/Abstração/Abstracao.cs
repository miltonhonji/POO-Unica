...
namespace POO.Abstração
{
    public class Abstracao
    {
        public void Execucao()
        {
            ...
            Console.WriteLine("Informe o valor do quadrado em metros.");
            ...
            Console.WriteLine($"A área do perimetro do quadrado é:  { quadrado.Perimetro} m");
            Console.ReadKey();
        }
